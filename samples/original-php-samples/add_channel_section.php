...
if ($client->getAccessToken ()) {
	try {
		...
		/*
		 * Before channel shelves will appear on your channel's web page, browse view needs to be enabled. If you know that your channel already has it enabled, or if you want to add a number of sections before enabling it, you can skip the call to enable_browse_view().
		 */
		...
		$htmlBody .= sprintf ( '<li>%s "%s"</li>', $insertResponse ['id'], $insertResponse ['snippet'] ['title'] );
		$htmlBody .= '</ul>';
